...
from watchlist_app.api.views import WatchListAV, WatchListDetailAV, StreamingPlatformListAV, StreamingPlatformDetailAV, ReviewList, ReviewDetail, ReviewCreate
